# Fivetran Connector SDK Hands on Lab at Big Data Paris 2025: Retail Dynamic Pricing
...
```
Here is the API spec for this dataset: https://sdk-demo-api-dot-internal-sales.uc.r.appspot.com/rdp_api_spec
...
5. Click [rdp_api_spec](https://sdk-demo-api-dot-internal-sales.uc.r.appspot.com/rdp_api_spec) if you'd like to see the API spec.
...
8. When prompted with "Do you want to continue? (Y/N):", type `Y` and press Enter.
    ...
    - You'll see output displaying the results of the debug script including:
        ...
        - Verifies data loading and schema creation by simulating a full sync (in this case, upserting 600 records into rdp_records).
